package com.g7.auto.debug.recovery.core;
...
import com.g7.auto.debug.recovery.tools.RecoverySharedPrefsUtil;
import com.g7.auto.debug.recovery.tools.RecoveryUtil;
import com.g7.auto.debug.recovery.tools.Reflect;
...
public final class RecoveryActivity extends Activity {
    ...
    private void initView() {
        ...
        mDbgBtn = (Button) findViewById(R.id.btn_debug);
        ...
        //mCrashTipsTv = (TextView) findViewById(R.id.tv_crash_tips);  //modified by shilin
    ...
    private void setupEvent() {
        ...
        mDbgBtn.setOnClickListener(new View.OnClickListener() {
            @Override
